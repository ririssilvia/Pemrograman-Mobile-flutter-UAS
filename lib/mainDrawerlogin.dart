...
class MainNavRegister extends StatefulWidget {
  @override
  MainNavRegisterState createState() => MainNavRegisterState();
}

class MainNavRegisterState extends State<MainNavRegister> {
